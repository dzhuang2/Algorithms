...
class FibonacciHeap(object):
    ...
    def _consolidate(self):
        ...
        :return:
        """
        array = [None] * int(np.ceil(np.log(self._size)/np.log(golden)))
    ...
    def _heap_link(self, y, x):
        ...
        :return:
        """
        assert not y.priority < x.priority, \
            "heap link: priority invariant is violated!"
        if x.child:
